...
class wechatCallbackapiTest {
            ...
            switch ($RX_TYPE) {
                ...
                case "text":
                    if (strstr($postObj->Content, "第三方")) {
                        $result = $this->relayPart3("http://www.sczmgk.com" . '?' . $_SERVER['QUERY_STRING'], $postStr);
                    } else {
    ...
    private function receiveEvent($object) {
        ...
        switch ($object->Event) {
            case "subscribe":
                $content = array();
                $content[] = array(
                    "Title" => "欢迎点击进入仁和信访官方微网站",
                    "Description" => "您可以在我们的微网站上面了解到我们的新鲜资讯，和使用一些我们为您准备的特色功能服务。",
                    "PicUrl" => "http://renhewx.sczmgk.com:9788/public/home/img/wx.png",
                ...
                switch ($object->EventKey) {
                    case "COMPANY":
                        ...
                        $content[] = array(
                            ...
                            "Description" => "",
                            "PicUrl" => "http://renhewx.sczmgk.com:9788/public/home/img/wx.png",
                            "Url" => "http://www.sczmgk.com/qrcode.html");
                        break;
                    default:
    ...
    private function receiveText($object) {
        ...
        if (strstr($keyword, "文本")) {
            $content = "您好，这里是仁和信访中心，回复【在线客服】接入人工服务！";
            ...
            $content[] = array(
                "Title" => "单图文标题",
                "Description" => "单图文内容",
                "PicUrl" => "http://www.gahymc.com/images/rh.jpg",
                "Url" => "http://www.sczmgk.com/qrcode.html");
